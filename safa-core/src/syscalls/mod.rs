...
pub fn syscall(
    ...
    fn inner(
        ...
        match syscall {
            SyscallTable::SysACtrl => arch::sysarch_ctrl_raw(a as u32, b as u64),
            ...
            SyscallTable::SysIOWriteNext => io::syswrite_next_raw(a as Ri, (b as *const u8, c)),
            SyscallTable::SysIOReadNext => io::sysread_next_raw(a as Ri, (b as *mut u8, c)),
            SyscallTable::SysIOSeek => io::sysseek_raw(a as Ri, (b as u8, c as usize)),
            SyscallTable::SysIOTell => io::systell_raw(a as Ri),
            ...
            SyscallTable::SysMemMap2 => mem::sysmem_map2_raw(a as *const _, b, c, d as *mut _),
            SyscallTable::SysMemOp => mem::sysmem_op_raw(a as *const _, b as *const _),
            SyscallTable::SysMemUnmap => mem::sysmem_unmap_raw(a, b),
            // Sockets
